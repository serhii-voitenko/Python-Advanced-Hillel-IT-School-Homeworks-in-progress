...
Вам необходимо собрать все имена героев в лист и вернуть его Собрать имена всех героев и их оружие и вернуть 
в виде {name: weapon} только для тех у кого есть оружие """
